      ...
      <div className="container">
        <div className="row">
          <div className="col l4 s12">
            <h2 style={{fontFamily: 'Oswald, sans-serif', color: '#F1F1F1'}}>Our Program</h2>
            <div style={{backgroundColor: '#F1F1F1'}} className="divider" />
            <ol style={{color: '#101010'}} className="flow-text">
              <li>
          ...
          <div className="col l8 s12">
            <h2 style={{fontFamily: 'Oswald, sans-serif', color: '#F1F1F1'}}>Our Mission</h2>
            <div style={{backgroundColor: '#F1F1F1'}} className="divider" />
            ...
            <h2 style={{fontFamily: 'Oswald, sans-serif', color: '#F1F1F1'}}>Other Sites</h2>
            <div style={{backgroundColor: '#F1F1F1'}} className="divider" />
            <div className="row">
              <div className="col s6">
                <a style={{color: '#101010'}} target="_blank" href="http://mnsoberhomes.org/"><p className="flow-text">M.A.S.H - Minnesota Association of Sober Homes</p></a>
                <a style={{color: '#101010'}} target="_blank" href="http://www.aa.org/"><p className="flow-text">Alcoholics Anonymous</p></a>
                <a style={{color: '#101010'}} target="_blank" href="http://www.aastpaul.org/"><p className="flow-text">Saint Paul Intergroup</p></a>
              </div>
              <div className="col s6">
                <a style={{color: '#101010'}} target="_blank" href="https://minnesotarecovery.org/"><p style={{marginLeft: '10px'}} className="flow-text">Minnesota Recovery Connection</p></a>
                <a style={{color: '#101010'}} target="_blank" href="http://www.hazelden.org/"><p style={{marginLeft: '10px'}} className="flow-text">Hazelden</p></a>
                <a style={{color: '#101010'}} target="_blank" href="https://www.theretreat.org/"><p style={{marginLeft: '10px'}} className="flow-text">The Retreat</p></a>
              </div>
            </div>
          </div>
        </div>
