  ...
  render() {
    return (
      <div style={{marginTop: '10px'}} className="container">
        ...
        <div className="row">
          <div style={{marginTop: '35px'}} className="col l4 offset-l1 s10 offset-s1 center-align">
            <img style={{width: '100%'}} src={Img5} />
          </div>
          <div className="col l6 s12">
            <p style={{color: '#F1F1F1'}} className="flow-text">
          ...
          <div className="col l3 hide-on-med-and-down">
            ...
            <p style={{color: '#F1F1F1'}}>Buffalo House is a Proud Member of the Minnesota Association of Sober Homes.</p>
          </div>
          <div className="col s7 hide-on-large-only">
            <img style={{width: '100%', marginTop: 35}} src={Mash} />
          </div>
          <div className="col s5 hide-on-large-only">
            <p className="flow-text left-align" style={{color: '#F1F1F1', marginTop: 17.136}}>Buffalo House is a Proud Member of the Minnesota Association of Sober Homes.</p>
          </div>
