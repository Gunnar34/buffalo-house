  ...
  render() {
    return (
      <div style={{marginTop: '10px'}} className="container">
        <h2 style={{fontFamily: 'Oswald, sans-serif', color: '#F1F1F1', textDecoration: 'underline'}}>The Buffalo House</h2>
        ...
        <div className="row">
          <div className="col s12 center-align">
            <h3 style={{textAlign: 'center', fontFamily: 'Oswald, sans-serif', color: '#F1F1F1'}}>Who We Are</h3>
          </div>
        ...
        <div className="row">
          ...
          <div className="col l3 hide-on-med-and-down">
            ...
            <p style={{color: '#101010'}}>Buffalo House is a Proud Member of the Minnesota Association of Sober Homes.</p>
          </div>
          <div className="col s7 hide-on-large-only">
            <img style={{width: '100%', marginTop: 35}} src={Mash} />
          </div>
          <div className="col s5 hide-on-large-only">
            <p className="flow-text left-align" style={{color: '#101010', marginTop: 17.136}}>Buffalo House is a Proud Member of the Minnesota Association of Sober Homes.</p>
          </div>
